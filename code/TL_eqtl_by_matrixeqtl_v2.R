...
# 创建循环对象
TL_list <- dir(path="/data2/usr/LiuWW/project_3/part8.eqtl/data/GE_TL")

TL_list <- str_sub(TL_list[c(5)], start = 1, end = -5)
...
for (i in TL_list) {
  ...
  expression_file_name = paste(base.dir, "/data/GE_TL/", i, ".txt", sep="");
  ...
  outdir = paste("./TWAS_candidate_eQTL/GE_TL/", i, sep = "")
